...
Go ahead and create a database, with a user and a passoword in postgres. Make sure that postgres is up and running. Go to App/example.env and fill out your creadentials. Rename the file to just ".env". Use the specified port 5000 if you can. 
